...
export class RTCPeer extends EventEmitter {
    ...
    onTrack(ev) {
        if (this.pc) {
            // If we are trying to reuse and existing transceiver to receive
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (track.kind === 'video') {
                ...
                if (isFirefox() && getFirefoxVersion() >= 110) {
                    ...
                    // We need to explicitly set the direction or Firefox will default to
                    // sendrecv which will cause problems when removing the track.
